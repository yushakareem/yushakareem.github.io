...
<div class="identity" id="intro" data-rail="intro">
  ...
  <div class="portrait">
    <div class="portrait-frame">
      ...
      <div class="eye" style="--cx:44.56%;--cy:22.31%;--rx:6px;--ry:3.4px"><img class="eyeball" src="{{ '/assets/img/yusha-portrait.jpg' | relative_url }}" alt="" aria-hidden="true"></div>
      <div class="eye" style="--cx:54.65%;--cy:22.55%;--rx:6px;--ry:3.4px"><img class="eyeball" src="{{ '/assets/img/yusha-portrait.jpg' | relative_url }}" alt="" aria-hidden="true"></div>
    </div>
  </div>
